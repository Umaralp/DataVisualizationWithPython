...
Original file is located at
    https://colab.research.google.com/drive/1GdM2NPh-_nMj4-lLdWOnfFCXitvCSST5
"""
...
p2.scatter(x, 3 * y, legend_label="3*sin(x)", marker="square", fill_color=None, line_color="green")
p2.line(x, 3 * y, legend_label="3*sin(x)", line_color="green")
p2.legend.title = "Lines"

# Combine into grid
layout = gridplot([[p1, p2]])  # Explicitly create a grid layout with both plots
